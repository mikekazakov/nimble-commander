...
- (void)updateFilter:(NSString *)_filter
{
    ...
    for( size_t i = 1, e = items.count; i < e; ++i ) {
...
- (bool)validateItem:(NSMenuItem *)_item
{
    ...
    return [_item.title rangeOfString:m_Filter options:NSCaseInsensitiveSearch].length > 0;
}
...
- (instancetype)initWithFrame:(NSRect)frameRect
{
    if( self = [super initWithFrame:frameRect] ) {
        ...
        [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[m_Query]-(==1)-|"
                                                                     ...
                                                                     metrics:nil
                                                                       views:views]];
        [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[m_Title]-(==1)-|"
                                                                     options:0
                                                                     metrics:nil
                                                                       views:views]];
    }
...
static OSStatus CarbonCallback(EventHandlerCallRef _handler, EventRef _event, void *_user_data)
{
