...
public:
    ...
    NSString* FileSizeToString(const VFSFListingItem &_dirent, const PanelVolatileData &_vd) const;
private:
    ...
    const ColoringAttrs& AttrsForItem(const VFSFListingItem& _item, const PanelVolatileData& _item_vd) const;
