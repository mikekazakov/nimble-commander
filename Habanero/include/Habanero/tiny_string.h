...
class tiny_string
{
    ...
    struct __is_input_iterator
        : public std::is_convertible<typename std::iterator_traits<_Tp>::iterator_category,
...
public:
    ...
    tiny_string &
    insert(size_type index, const tiny_string &str, size_type index_str, size_type count = npos);
    iterator insert(const_iterator pos, value_type ch);
    iterator insert(const_iterator pos, size_type count, value_type ch);
    template <class InputIterator>
    typename std::enable_if<__is_input_iterator<InputIterator>::value &&
                                !__is_forward_iterator<InputIterator>::value,
                            iterator>::type
    insert(const_iterator pos, InputIterator first, InputIterator last);
    template <class ForwardIterator>
    typename std::enable_if<__is_forward_iterator<ForwardIterator>::value, iterator>::type
    ...
    template <class ForwardIterator>
    typename std::enable_if<__is_forward_iterator<ForwardIterator>::value, tiny_string &>::type
    append(ForwardIterator first, ForwardIterator last);
    ...
    tiny_string &replace(size_type pos,
                         size_type count1,
                         const tiny_string &str,
                         size_type pos2,
    ...
    tiny_string &
    replace(const_iterator first, const_iterator last, const_pointer s, size_type count2);
    ...
    tiny_string &
    replace(const_iterator first, const_iterator last, size_type count2, value_type ch);
    tiny_string &
    replace(const_iterator first, const_iterator last, std::initializer_list<value_type> ilist);
...
typename std::enable_if<tiny_string::__is_input_iterator<_InputIterator>::value &&
                            !tiny_string::__is_forward_iterator<_InputIterator>::value,
                        tiny_string &>::type
tiny_string::append(_InputIterator __first, _InputIterator __last)
{
...
typename std::enable_if<tiny_string::__is_forward_iterator<_ForwardIterator>::value,
                        tiny_string &>::type
tiny_string::append(_ForwardIterator __first, _ForwardIterator __last)
{
...
typename std::enable_if<tiny_string::__is_input_iterator<_InputIterator>::value &&
                            !tiny_string::__is_forward_iterator<_InputIterator>::value,
                        tiny_string::iterator>::type
tiny_string::insert(const_iterator pos, _InputIterator first, _InputIterator last)
{
    auto old_sz = size();
    auto d = size_type(pos - begin());
    for( ; first != last; ++first )
...
typename std::enable_if<tiny_string::__is_forward_iterator<_ForwardIterator>::value,
                        tiny_string::iterator>::type
tiny_string::insert(const_iterator pos, _ForwardIterator first, _ForwardIterator last)
{
    auto _sz = size();
    auto d = size_type(pos - begin());
...
inline tiny_string::iterator tiny_string::insert(const_iterator pos,
...
inline tiny_string &tiny_string::replace(const_iterator first,
                                         const_iterator last,
                                         std::initializer_list<value_type> ilist)
{
...
inline tiny_string::size_type tiny_string::find(const tiny_string &str,
...
inline tiny_string::size_type tiny_string::rfind(const tiny_string &str,
                                                 size_type pos) const noexcept
{
