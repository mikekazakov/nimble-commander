...
bool ToggleLayout::Predicate( PanelController *_target )
{
...
bool ToggleLayout::ValidateMenuItem( PanelController *_target, NSMenuItem *_item )
{
    _item.state = _target.layoutIndex == m_Index;
    return Predicate(_target);
}

void ToggleLayout::Perform( PanelController *_target, id _sender )
{
