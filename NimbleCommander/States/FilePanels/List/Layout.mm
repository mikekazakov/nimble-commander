...
PanelListViewColumnsLayout::Column::Column() noexcept
    : kind(PanelListViewColumns::Empty), width(-1), max_width(-1), min_width(-1)
{
}

bool PanelListViewColumnsLayout::Column::operator==(const Column &_rhs) const noexcept
{
    return kind == _rhs.kind && width == _rhs.width && max_width == _rhs.max_width &&
...
PanelListViewColumnsLayout::PanelListViewColumnsLayout() noexcept : icon_scale(1)
{
}

bool PanelListViewColumnsLayout::operator==(const PanelListViewColumnsLayout &_rhs) const noexcept
{
    return columns == _rhs.columns && icon_scale == _rhs.icon_scale;
}
