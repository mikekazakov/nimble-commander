...
- (void)createControls
{
    ...
    NSBox *cpu_box = [[NSBox alloc] initWithFrame:NSRect()];
    {
        ...
        m_TextCPULoadSystem.textColor = [NSColor colorWithCalibratedRed:1.00
                                                                  green:0.15
                                                                   blue:0.10
                                                                  alpha:1.0];
        ...
        m_TextCPULoadUser.textColor = [NSColor colorWithCalibratedRed:0.10
                                                                green:0.15
                                                                 blue:1.00
                                                                alpha:1.0];
        ...
        [cpu_box
            addConstraints:[NSLayoutConstraint
                               constraintsWithVisualFormat:@"|-(==8)-[cpu_sysload_title]-(==8)-[m_"
                                                           @"TextCPULoadSystem(>=60)]-(==8)-|"
                                                   options:0
                                                   metrics:nil
                                                     views:cpu_box_views]];
        [cpu_box
            addConstraints:[NSLayoutConstraint
                               constraintsWithVisualFormat:@"|-(==8)-[cpu_usrload_title]-(==8)-[m_"
                                                           @"TextCPULoadUser(>=60)]-(==8)-|"
                                                   options:0
                                                   metrics:nil
                                                     views:cpu_box_views]];
        [cpu_box addConstraints:[NSLayoutConstraint
                                    constraintsWithVisualFormat:@"|-(==8)-[cpu_idle_title]-(==8)-["
                                                                @"m_TextCPULoadIdle(>=60)]-(==8)-|"
                                                        options:0
                                                        metrics:nil
                                                          views:cpu_box_views]];
        [cpu_box addConstraints:[NSLayoutConstraint
                                    constraintsWithVisualFormat:@"|-(==1)-[line1]-(==1)-|"
                                                        options:0
                                                        metrics:nil
                                                          views:cpu_box_views]];
        [cpu_box addConstraints:[NSLayoutConstraint
                                    constraintsWithVisualFormat:@"|-(==1)-[line2]-(==1)-|"
                                                        options:0
                                                        metrics:nil
                                                          views:cpu_box_views]];
        [cpu_box
            addConstraints:[NSLayoutConstraint
                               constraintsWithVisualFormat:
                                   @"V:|-(==8)-[cpu_sysload_title]-(<=1)-[line1(==1)]-(==7)-[cpu_"
                                   @"usrload_title]-(<=1)-[line2(==1)]-(==7)-[cpu_idle_title]"
                                                   options:0
                                                   metrics:nil
                                                     views:cpu_box_views]];
        [cpu_box
            addConstraints:[NSLayoutConstraint
                               constraintsWithVisualFormat:@"V:[m_TextCPULoadSystem]-(<=1)-[line1]"
                                                   options:0
                                                   metrics:nil
                                                     views:cpu_box_views]];
        [cpu_box
            addConstraints:[NSLayoutConstraint
                               constraintsWithVisualFormat:@"V:[m_TextCPULoadUser]-(<=1)-[line2]"
                                                   options:0
                                                   metrics:nil
                                                     views:cpu_box_views]];
        [cpu_box
            addConstraints:[NSLayoutConstraint
                               constraintsWithVisualFormat:@"V:[line2]-(==7)-[m_TextCPULoadIdle]"
                                                   options:0
                                                   metrics:nil
                                                     views:cpu_box_views]];
    }
    ...
    NSBox *ram_box = [[NSBox alloc] initWithFrame:NSRect()];
    {
        ...
        NSDictionary *ram_box_views = NSDictionaryOfVariableBindings(m_TextMemTotal,
                                                                     ...
                                                                     line1,
                                                                     line2);
        [ram_box addConstraints:[NSLayoutConstraint
                                    constraintsWithVisualFormat:
                                        @"|-(==8)-[ram_total_title]-(==8)-[m_TextMemTotal]-(==8)-|"
                                                        options:0
                                                        metrics:nil
                                                          views:ram_box_views]];
        [ram_box addConstraints:[NSLayoutConstraint
                                    constraintsWithVisualFormat:
                                        @"|-(==8)-[ram_used_title]-(==8)-[m_TextMemUsed]-(==8)-|"
                                                        options:0
                                                        metrics:nil
                                                          views:ram_box_views]];
        [ram_box addConstraints:[NSLayoutConstraint
                                    constraintsWithVisualFormat:
                                        @"|-(==8)-[ram_swap_title]-(==8)-[m_TextMemSwap]-(==8)-|"
                                                        options:0
                                                        metrics:nil
                                                          views:ram_box_views]];
        [ram_box addConstraints:[NSLayoutConstraint
        ...
        [ram_box addConstraints:[NSLayoutConstraint
                                    constraintsWithVisualFormat:
                                        @"V:|-(==8)-[ram_total_title]-(<=1)-[line1(==1)]-(==7)-["
                                        @"ram_used_title]-(<=1)-[line2(==1)]-(==7)-[ram_swap_title]"
                                                        options:0
                                                        metrics:nil
                                                          views:ram_box_views]];
        [ram_box addConstraints:[NSLayoutConstraint
                                    constraintsWithVisualFormat:@"V:[m_TextMemTotal]-(<=1)-[line1]"
                                                        options:0
                                                        metrics:nil
                                                          views:ram_box_views]];
        [ram_box addConstraints:[NSLayoutConstraint
                                    constraintsWithVisualFormat:@"V:[m_TextMemUsed]-(<=1)-[line2]"
                                                        options:0
                                                        metrics:nil
                                                          views:ram_box_views]];
        [ram_box addConstraints:[NSLayoutConstraint
                                    constraintsWithVisualFormat:@"V:[line2]-(==7)-[m_TextMemSwap]"
                                                        options:0
                                                        metrics:nil
                                                          views:ram_box_views]];
    }
    ...
    NSBox *system_box = [[NSBox alloc] initWithFrame:NSRect()];
    {
        ...
        [system_box
            addConstraints:[NSLayoutConstraint
                               constraintsWithVisualFormat:
                                   @"|-(==8)-[model_title]-(==8)-[m_TextMachineModel]-(==8)-|"
                                                   options:0
                                                   metrics:nil
        ...
        [system_box
            addConstraints:[NSLayoutConstraint
                               constraintsWithVisualFormat:
                                   @"|-(==8)-[computer_title]-(==8)-[m_TextComputerName]-(==8)-|"
                                                   options:0
                                                   metrics:nil
                                                     views:system_box_views]];
        [system_box addConstraints:[NSLayoutConstraint
                                       constraintsWithVisualFormat:
                                           @"|-(==8)-[user_title]-(==8)-[m_TextUserName]-(==8)-|"
                                                           options:0
                                                           metrics:nil
                                                             views:system_box_views]];
        [system_box addConstraints:[NSLayoutConstraint
        ...
        [system_box addConstraints:[NSLayoutConstraint
                                       constraintsWithVisualFormat:
                                           @"V:|-(==8)-[model_title]-(<=1)-[line1(==1)]-(==7)-["
                                           @"computer_title]-(<=1)-[line2(==1)]-(==7)-[user_title]"
                                                           options:0
                                                           metrics:nil
                                                             views:system_box_views]];
        [system_box
            addConstraints:[NSLayoutConstraint
                               constraintsWithVisualFormat:@"V:[m_TextMachineModel]-(<=1)-[line1]"
                                                   options:0
                                                   metrics:nil
                                                     views:system_box_views]];
        [system_box
            addConstraints:[NSLayoutConstraint
                               constraintsWithVisualFormat:@"V:[m_TextComputerName]-(<=1)-[line2]"
                                                   options:0
                                                   metrics:nil
                                                     views:system_box_views]];
        [system_box
            addConstraints:[NSLayoutConstraint
                               constraintsWithVisualFormat:@"V:[line2]-(==7)-[m_TextUserName]"
                                                   options:0
                                                   metrics:nil
                                                     views:system_box_views]];
    }
    ...
    NSBox *storage_box = [[NSBox alloc] initWithFrame:NSRect()];
    {
        ...
        [storage_box addConstraints:[NSLayoutConstraint
                                        constraintsWithVisualFormat:
                                            @"|-(==8)-[vol_title]-(==8)-[m_TextVolumeName]-(==8)-|"
                                                            options:0
                                                            metrics:nil
                                                              views:storage_views]];
        [storage_box
            addConstraints:[NSLayoutConstraint
                               constraintsWithVisualFormat:
                                   @"|-(==8)-[bytes_title]-(==8)-[m_TextVolumeTotalBytes]-(==8)-|"
                                                   options:0
                                                   metrics:nil
                                                     views:storage_views]];
        [storage_box
            addConstraints:[NSLayoutConstraint
                               constraintsWithVisualFormat:
                                   @"|-(==8)-[free_title]-(==8)-[m_TextVolumeAvailBytes]-(==8)-|"
                                                   options:0
                                                   metrics:nil
                                                     views:storage_views]];
        [storage_box addConstraints:[NSLayoutConstraint
        ...
        [storage_box addConstraints:[NSLayoutConstraint
                                        constraintsWithVisualFormat:
                                            @"V:|-(==8)-[vol_title]-(<=1)-[line1(==1)]-(==7)-["
                                            @"bytes_title]-(<=1)-[line2(==1)]-(==7)-[free_title]"
                                                            options:0
                                                            metrics:nil
                                                              views:storage_views]];
        [storage_box
            addConstraints:[NSLayoutConstraint
                               constraintsWithVisualFormat:@"V:[m_TextVolumeName]-(<=1)-[line1]"
                                                   options:0
                                                   metrics:nil
                                                     views:storage_views]];
        [storage_box addConstraints:
                         [NSLayoutConstraint
                             constraintsWithVisualFormat:@"V:[m_TextVolumeTotalBytes]-(<=1)-[line2]"
                                                 options:0
                                                 metrics:nil
                                                   views:storage_views]];
        [storage_box addConstraints:
                         [NSLayoutConstraint
                             constraintsWithVisualFormat:@"V:[line2]-(==7)-[m_TextVolumeAvailBytes]"
                                                 options:0
                                                 metrics:nil
                                                   views:storage_views]];
    }
    ...
    [self addConstraints:[NSLayoutConstraint
                             constraintsWithVisualFormat:@"V:|-(==8)-[title]-[system_box(==90)]-["
                                                         @"cpu_box(==90)]-[storage_box(==90)]"
                                                 options:0
                                                 metrics:nil
                                                   views:views]];
    [self addConstraints:[NSLayoutConstraint
                             constraintsWithVisualFormat:@"V:[system_box]-[ram_box(==90)]"
                                                 options:0
                                                 metrics:nil
                                                   views:views]];
