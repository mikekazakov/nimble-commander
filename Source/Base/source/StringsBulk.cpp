...
// StringsBulk
////////////////////////////////////////////////////////////////////////////////////////////////////
StringsBulk::StringsBulk() noexcept : m_Count(0), m_Ctrl(nullptr)
{
...
StringsBulk::StringsBulk(StringsBulk &&_rhs) noexcept : m_Count(_rhs.m_Count), m_Ctrl(_rhs.m_Ctrl)
{
    _rhs.m_Count = 0;
    _rhs.m_Ctrl = nullptr;
}

StringsBulk::StringsBulk(size_t _strings_amount, Ctrl *_data) noexcept : m_Count(_strings_amount), m_Ctrl(_data)
{
}
...
static bool lexicographical_strcmp_compare(_InputIterator1 __first1,
