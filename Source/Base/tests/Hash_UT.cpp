...
{
    std::string d = "6Bwbu8HbVqF*GPNL$BR[Jh4Nk)$!afU#w6[erC4yYX2&$]VUzGjsaQ6M#%ZdJk${VbsWw_!F^NMnfDCC5A=5bPNf(#*"
    ...
    CHECK(Hash::Hex(Hash(Hash::SHA2_512).Feed(d.c_str(), d.size()).Final()) ==
          "5e648bcc3fc9ebd87128a9272167af99a12df927d2dbc1547674827a7a91ccafe61a4dfa92e209b41b98dbe2bd204f049bd3730496b4"
