...
static constexpr std::pair<const char *, uint64_t> g_EntryToNotificationMappingTable[] = {
    ...
    {"filePanelsHeaderPathHoverColor", TMN::FilePanelsHeader},
    {"filePanelsHeaderPathSelectionColor", TMN::FilePanelsHeader},
    ...
    {"filePanelsBriefRowVerticalPadding", TMN::FilePanelsBrief},
