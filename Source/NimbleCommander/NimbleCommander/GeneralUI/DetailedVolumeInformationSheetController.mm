...
@synthesize MountedAtTextField;
@synthesize DeviceTextField;
@synthesize FormatTextField;
@synthesize TotalBytesTextField;
@synthesize FreeBytesTextField;
@synthesize AvailableBytesTextField;
@synthesize UsedBytesTextField;
@synthesize ObjectsCountTextField;
@synthesize FileCountTextField;
@synthesize FoldersCountTextField;
@synthesize MaxObjectsTextField;
@synthesize IOBlockSizeTextField;
@synthesize MinAllocationTextField;
@synthesize AllocationClumpTextField;
@synthesize AdvancedTextView;
...
- (void)windowDidLoad
{
    ...
    NSString *formatcap = [NSString stringWithFormat:@"Format capabilities:\n"
    ...
    NSString *formatint = [NSString stringWithFormat:@"Format interfaces:\n"
    ...
    NSString *attrcmn = [NSString stringWithFormat:@"Common attributes:\n"
                                                    "\tATTR_CMN_NAME: %@\n"
                                                    "\tATTR_CMN_DEVID: %@\n"
                                                    "\tATTR_CMN_FSID: %@\n"
                                                    "\tATTR_CMN_OBJTYPE: %@\n"
    ...
    NSString *attrvol = [NSString stringWithFormat:@"Volume attributes:\n"
                                                    "\tATTR_VOL_FSTYPE: %@\n"
                                                    "\tATTR_VOL_SIGNATURE: %@\n"
                                                    "\tATTR_VOL_SIZE: %@\n"
                                                    "\tATTR_VOL_SPACEFREE: %@\n"
    ...
    NSString *attrdir = [NSString stringWithFormat:@"Directory attributes:\n"
                                                    "\tATTR_DIR_LINKCOUNT: %@\n"
                                                    "\tATTR_DIR_ENTRYCOUNT: %@\n"
    ...
    NSString *attrfile = [NSString stringWithFormat:@"File attributes:\n"
                                                     "\tATTR_FILE_LINKCOUNT: %@\n"
                                                     "\tATTR_FILE_TOTALSIZE: %@\n"
                                                     "\tATTR_FILE_ALLOCSIZE: %@\n"
    ...
    NSString *advstr =
        [NSString stringWithFormat:@"%@%@%@%@%@%@%@", uuid, formatcap, formatint, attrcmn, attrvol, attrdir, attrfile];
