...
public:
    ...
    [[nodiscard]] virtual std::optional<int> TagFromAction(std::string_view _action) const noexcept = 0;

    // Returns an action name of the given numeric tag.
    [[nodiscard]] virtual std::optional<std::string_view> ActionFromTag(int _tag) const noexcept = 0;
    ...
    [[nodiscard]] virtual std::optional<Shortcuts> ShortcutsFromAction(std::string_view _action) const noexcept = 0;

    // Returns a shortcut assigned to the specified numeric action tag.
    // Returns std::nullopt such action cannot be found.
    // Overrides have priority over the default shortcuts.
    [[nodiscard]] virtual std::optional<Shortcuts> ShortcutsFromTag(int _tag) const noexcept = 0;

    // Returns a default shortcut for an action specified by its numeric tag.
    // Returns std::nullopt such action cannot be found.
    [[nodiscard]] virtual std::optional<Shortcuts> DefaultShortcutsFromTag(int _tag) const noexcept = 0;
    ...
    [[nodiscard]] virtual std::optional<ActionTags>
    ActionTagsFromShortcut(Shortcut _sc, std::string_view _in_domain = {}) const noexcept = 0;
    ...
    [[nodiscard]] virtual std::vector<std::pair<std::string, int>> AllShortcuts() const = 0;
