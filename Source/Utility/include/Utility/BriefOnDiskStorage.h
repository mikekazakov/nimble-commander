...
public:
     ...
     */
    virtual std::optional<PlacementResult> Place(const void *_data, long _bytes) = 0;
     ...
     * The temporary file will be erased when PlacementResult object is destroyed.
     */
    virtual std::optional<PlacementResult>
    PlaceWithExtension(const void *_data, long _bytes, const std::string &_extension) = 0;
};
