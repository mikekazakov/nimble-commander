...
void InterpretAsUnichar(int _encoding,
...
{
    switch( _encoding ) {
        case ENCODING_MACOS_ROMAN_WESTERN:
...
int FromCFStringEncoding(int _encoding)
{
    switch( _encoding ) {
        case kTextEncodingMacRoman:
            return ENCODING_MACOS_ROMAN_WESTERN;
        case 0x08000100:
        ...
        case 0x00000100:
            return ENCODING_UTF16LE; // generic UTF16 - currently maps to UTF16LE
...
#define _(a)                                                                                                           \
    encodings.emplace_back(                                                                                            \
        a,                                                                                                             \
        static_cast<CFStringRef>(CFBridgingRetain([NSString                                                            \
            localizedNameOfStringEncoding:CFStringConvertEncodingToNSStringEncoding(ToCFStringEncoding(a))])))
