                                     ...
                                     VolumeAttributesInformation *_a)
{
    struct {
        ...
        union {
            struct {
                u_int32_t val;
            } __attribute__((aligned(4), packed)) fstype;
            struct {
                u_int32_t val;
            } __attribute__((aligned(4), packed)) signature;
            struct {
                off_t val;
            } __attribute__((aligned(4), packed)) size;
            struct {
                off_t val;
            } __attribute__((aligned(4), packed)) spacefree;
            struct {
                off_t val;
            } __attribute__((aligned(4), packed)) spaceavail;
            struct {
                off_t val;
            } __attribute__((aligned(4), packed)) minallocation;
            struct {
                off_t val;
            } __attribute__((aligned(4), packed)) allocationclump;
            struct {
                u_int32_t val;
            } __attribute__((aligned(4), packed)) ioblocksize;
            struct {
                u_int32_t val;
            } __attribute__((aligned(4), packed)) objcount;
            struct {
                u_int32_t val;
            } __attribute__((aligned(4), packed)) filecount;
            struct {
                u_int32_t val;
            } __attribute__((aligned(4), packed)) dircount;
            struct {
                u_int32_t val;
            } __attribute__((aligned(4), packed)) maxobjcount;
            struct {
                attrreference val;
                char buf[MAXPATHLEN];
            } __attribute__((aligned(4), packed)) mountpoint;
            struct {
                attrreference val;
                char buf[NAME_MAX + 1];
            } __attribute__((aligned(4), packed)) name;
            struct {
                u_int32_t val;
            } __attribute__((aligned(4), packed)) mountflags;
            struct {
                attrreference val;
                char buf[MAXPATHLEN];
            } __attribute__((aligned(4), packed)) mounteddevice;
            struct {
                unsigned long long val;
            } __attribute__((aligned(4), packed)) encodingused;
            struct {
                uuid_t val;
            } __attribute__((aligned(4), packed)) uuid;
        };
    } __attribute__((aligned(4), packed)) info;
