...
public:
     ...
     * May return nil.
     */
    virtual NSImage *ThumbnailIfHas(const std::string &_file_path, int _px_size) = 0;
     ...
     * May return nil.
     */
    virtual NSImage *ProduceThumbnail(const std::string &_file_path, int _px_size) = 0;
     ...
     */
    virtual NSImage *ProduceThumbnail(const std::string &_file_path, int _px_size, const FileStateHint &_hint) = 0;
};
