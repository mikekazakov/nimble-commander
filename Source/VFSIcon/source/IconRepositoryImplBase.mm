...
[[clang::no_destroy]] const std::shared_ptr<Base::Executor> Base::MainQueueExecutor::instance{
    std::make_shared<Base::MainQueueExecutor>()};
...
{
    auto block = [this, client_block = std::move(_client_block)] { RunBlock(client_block); };
