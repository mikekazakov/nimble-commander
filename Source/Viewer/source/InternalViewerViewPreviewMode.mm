...
InternalViewerViewPreviewMode::InternalViewerViewPreviewMode(const std::string &_native_path, BigFileView *_view)
    : m_NativePath(_native_path), m_View(_view),
      m_Preview([[QLPreviewView alloc] initWithFrame:NSMakeRect(0, 0, 100, 100)])
{
    ...
    [_view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|-(==0)-[m_Preview]-(==0)-|"
                                                                  options:0
                                                                  metrics:nil
                                                                    views:views]];
    [_view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-(==0)-[m_Preview]-(==0)-|"
                                                                  options:0
                                                                  metrics:nil
                                                                    views:views]];
}
