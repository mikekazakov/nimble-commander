...
static std::optional<input::CharacterAttributes> SCImToCharacterAttributes(int _ps) noexcept
{
    ...
    switch( _ps ) {
        ...
        case 30: return CA{.mode = CA::ForegroundColor, .color = Color::Black};
        case 31: return CA{.mode = CA::ForegroundColor, .color = Color::Red};
        case 32: return CA{.mode = CA::ForegroundColor, .color = Color::Green};
        case 33: return CA{.mode = CA::ForegroundColor, .color = Color::Yellow};
        case 34: return CA{.mode = CA::ForegroundColor, .color = Color::Blue};
        case 35: return CA{.mode = CA::ForegroundColor, .color = Color::Magenta};
        case 36: return CA{.mode = CA::ForegroundColor, .color = Color::Cyan};
        case 37: return CA{.mode = CA::ForegroundColor, .color = Color::White};
        case 39: ca.mode = CA::ForegroundDefault; return ca;
        case 40: return CA{.mode = CA::BackgroundColor, .color = Color::Black};
        case 41: return CA{.mode = CA::BackgroundColor, .color = Color::Red};
        case 42: return CA{.mode = CA::BackgroundColor, .color = Color::Green};
        case 43: return CA{.mode = CA::BackgroundColor, .color = Color::Yellow};
        case 44: return CA{.mode = CA::BackgroundColor, .color = Color::Blue};
        case 45: return CA{.mode = CA::BackgroundColor, .color = Color::Magenta};
        case 46: return CA{.mode = CA::BackgroundColor, .color = Color::Cyan};
        case 47: return CA{.mode = CA::BackgroundColor, .color = Color::White};
        case 49: ca.mode = CA::BackgroundDefault; return ca;
        case 90: return CA{.mode = CA::ForegroundColor, .color = Color::BrightBlack};
        case 91: return CA{.mode = CA::ForegroundColor, .color = Color::BrightRed};
        case 92: return CA{.mode = CA::ForegroundColor, .color = Color::BrightGreen};
        case 93: return CA{.mode = CA::ForegroundColor, .color = Color::BrightYellow};
        case 94: return CA{.mode = CA::ForegroundColor, .color = Color::BrightBlue};
        case 95: return CA{.mode = CA::ForegroundColor, .color = Color::BrightMagenta};
        case 96: return CA{.mode = CA::ForegroundColor, .color = Color::BrightCyan};
        case 97: return CA{.mode = CA::ForegroundColor, .color = Color::BrightWhite};
        case 100: return CA{.mode = CA::BackgroundColor, .color = Color::BrightBlack};
        case 101: return CA{.mode = CA::BackgroundColor, .color = Color::BrightRed};
        case 102: return CA{.mode = CA::BackgroundColor, .color = Color::BrightGreen};
        case 103: return CA{.mode = CA::BackgroundColor, .color = Color::BrightYellow};
        case 104: return CA{.mode = CA::BackgroundColor, .color = Color::BrightBlue};
        case 105: return CA{.mode = CA::BackgroundColor, .color = Color::BrightMagenta};
        case 106: return CA{.mode = CA::BackgroundColor, .color = Color::BrightCyan};
        case 107: return CA{.mode = CA::BackgroundColor, .color = Color::BrightWhite};
