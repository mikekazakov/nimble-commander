...
static bool is_named(NSColor *_color)
{
...
{
    double r, g, b, a;
    if( !is_named(self) && self.colorSpace == NSColorSpace.genericRGBColorSpace )
        [self getRed:&r green:&g blue:&b alpha:&a];
    else
        [[self colorUsingColorSpace:NSColorSpace.genericRGBColorSpace] getRed:&r
                                                                        green:&g
                                                                         blue:&b
                                                                        alpha:&a];
