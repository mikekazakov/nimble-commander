...
TEST_CASE(PREFIX"Just some tests")
{
    ...
    CHECK( [f.ToNSString(1024*1024+10, t) isEqualToString:@"1.0 MB"] );
    CHECK( [f.ToNSString(1024*1024*1.5, t) isEqualToString:@"1.5 MB"] );
    CHECK( [f.ToNSString(1024*9.9, t) isEqualToString:@"9.9 KB"] );
    CHECK( [f.ToNSString(1024*9.97, t) isEqualToString:@"10 KB"] );
    CHECK( [f.ToNSString(1024*1024*9.97, t) isEqualToString:@"10 MB"] );
    CHECK( [f.ToNSString(1024*1024*5.97, t) isEqualToString:@"6.0 MB"] );
    CHECK( [f.ToNSString(1024*1024*5.90, t) isEqualToString:@"5.9 MB"] );
    CHECK( [f.ToNSString(1024ull*1024ull*1024ull*5.5, t) isEqualToString:@"5.5 GB"] );
    CHECK( [f.ToNSString(1024ull*1024ull*1024ull*10.5, t) isEqualToString:@"10 GB"] );
    CHECK( [f.ToNSString(1024ull*1024ull*1024ull*10.6, t) isEqualToString:@"11 GB"] );
    CHECK( [f.ToNSString(1024ull*1024ull*1024ull*156.6, t) isEqualToString:@"157 GB"] );
    CHECK( [f.ToNSString(10138681344ull, t) isEqualToString:@"9.5 GB"] );
    CHECK( [f.ToNSString(1024ull*1024ull*1024ull*1024ull*2.3, t) isEqualToString:@"2.3 TB"] );
