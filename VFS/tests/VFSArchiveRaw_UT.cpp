...
static const unsigned char __hello_txt_gz[] = {0x1f, 0x8b, 0x08, 0x08, 0xb6, 0x29, 0xef, 0x61, 0x00,
...
static const unsigned char __hello_txt_bz2[] = {
...
static const unsigned char __hello_txt_lz4[] = {0x04, 0x22, 0x4d, 0x18, 0x64, 0x40, 0xa7, 0x05,
...
static const unsigned char __hello_txt_lzma[] = {
    0x5d, 0x00, 0x00, 0x80, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00,
    0x34, 0x19, 0x49, 0xee, 0x8e, 0x68, 0x21, 0xff, 0xff, 0xff, 0xb9, 0xe0, 0x00, 0x00};
...
static const unsigned char __hello_txt_lz[] = {
    0x4c, 0x5a, 0x49, 0x50, 0x01, 0x0c, 0x00, 0x34, 0x19, 0x49, 0xee, 0x8e, 0x68, 0x21,
    0xff, 0xff, 0xff, 0xb9, 0xe0, 0x00, 0x00, 0x86, 0xa6, 0x10, 0x36, 0x05, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x29, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
static const unsigned int __hello_txt_lz_len = 41;

static const unsigned char __hello_txt_lzo[] = {
    0x89, 0x4c, 0x5a, 0x4f, 0x00, 0x0d, 0x0a, 0x1a, 0x0a, 0x10, 0x40, 0x20, 0xa0, 0x09,
    0x40, 0x01, 0x05, 0x03, 0x00, 0x00, 0x01, 0x00, 0x00, 0x81, 0xa4, 0x61, 0xef, 0x29,
    0xb6, 0x00, 0x00, 0x00, 0x00, 0x09, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x74, 0x78,
    0x74, 0x77, 0xac, 0x08, 0x63, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x05, 0x06,
    0x2c, 0x02, 0x15, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x00, 0x00, 0x00, 0x00};
...
static void check(const Case &test_case)
{
    ...
    REQUIRE(nc::base::WriteAtomically(
        path, {reinterpret_cast<const std::byte *>(test_case.bytes), test_case.size}));
...
TEST_CASE(PREFIX "gracefully discards non-compressed input")
{
    ...
    for( const auto &tc : cases ) {
        REQUIRE(nc::base::WriteAtomically(
            path, {reinterpret_cast<const std::byte *>(tc.data()), tc.size()}));
        try {
